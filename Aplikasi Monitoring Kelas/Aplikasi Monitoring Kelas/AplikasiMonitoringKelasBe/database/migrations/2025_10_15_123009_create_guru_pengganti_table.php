...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('guru_pengganti', function (Blueprint $table) {
            $table->id();
            $table->foreignId('guru_pengganti_id')->constrained('users')->onDelete('cascade');
            ...
            $table->foreignId('assigned_by')->constrained('users')->onDelete('cascade'); // kurikulum yang assign
            $table->timestamps();
        });
    }
